...
| CI evidence | [#439](https://github.com/ferrum-edge/ferrum-foundry/pull/439), which moved the pin to v0.9.7, and this release's Pre-publication Gates, which re-run every gate against the same image before anything is published |
