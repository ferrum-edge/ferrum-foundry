...
description: Dispatch and orchestrate Claude Fable 5.1 CLI subagents (low|medium|high|xhigh|max effort) for Ferrum Foundry issue, PR, review-feedback, CI-repair, and shepherding work. Use when the user asks Claude to delegate to Claude Fable 5.1 workers. Do not use when you are a dispatched worker or for ordinary single-agent edits.
---
