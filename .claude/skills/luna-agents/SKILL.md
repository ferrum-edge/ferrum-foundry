---
name: luna-agents
description: Dispatch and orchestrate GPT-6 Luna CLI subagents (low|medium|high|xhigh|max effort) for Ferrum Foundry issue, PR, review-feedback, CI-repair, and shepherding work. Use when the user asks Claude to delegate to GPT-6 Luna workers. Do not use when you are a dispatched worker or for ordinary single-agent edits.
---
